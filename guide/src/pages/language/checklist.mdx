...
Need more info on any of these points? See the Writing Advice section in the
...
* [ ] Check that each word agrees with what’s in the interface and the product
      lexicon.
...
* [ ] Show your text to a friend in design for a sanity check (have the courage
      to be vulnerable!).
